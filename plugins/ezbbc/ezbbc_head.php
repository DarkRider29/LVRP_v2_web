...
<?php if ($textarea_name == 'req_message'): ?>
 <?php if ($pun_config['p_message_bbcode'] == '1'): ?>
  // if BBcode enabled
	...
	toolbar += '<a href="#" id="bold" title="<?php echo $lang_ezbbc['Bold title'] ?>" onclick="replaceTag(<b>,</b>,\'\'); return false;"><span>Gras<\/span><\/a>';
	<?php endif; ?>
	<?php if ($ezbbc_config['u'] == 'u'): ?>
	toolbar += '<a href="#" id="underline" title="<?php echo $lang_ezbbc['Underline title'] ?>" onclick="insertTag(\'[u]\',\'[/u]\',\'\'); return false;"><span>Souligné<\/span><\/a>';
	<?php endif; ?>
	<?php if ($ezbbc_config['i'] == 'i'): ?>
	toolbar += '<a href="#" id="italic" title="<?php echo $lang_ezbbc['Italic title'] ?>" onclick="insertTag(\'[i]\',\'[/i]\',\'\'); return false;"><span>Italic<\/span><\/a>';
	<?php endif; ?>
	<?php if ($ezbbc_config['s'] == 's'): ?>
	toolbar += '<a href="#" id="strike" title="<?php echo $lang_ezbbc['Strike-through title'] ?>" onclick="insertTag(\'[s]\',\'[/s]\',\'\'); return false;"><span>Barré<\/span><\/a>';
	<?php endif; ?>
	...
	<?php endif; ?>
	<?php if ($ezbbc_config['center'] == 'center'): ?>
	toolbar += '<a href="#" id="center"  title=Center onclick="insertTag(\'[center]\',\'[/center]\',\'\'); return false;"><span>Centré<\/span><\/a>';
	<?php endif; ?>
	<?php if ($ezbbc_config['left'] == 'left'): ?>
	toolbar += '<a href="#" id="left"  title=Gauche onclick="insertTag(\'[left]\',\'[/left]\',\'\'); return false;"><span>Gauche<\/span><\/a>';
	<?php endif; ?>
	<?php if ($ezbbc_config['right'] == 'right'): ?>
	toolbar += '<a href="#" id="right"  title=Droite onclick="insertTag(\'[right]\',\'[/right]\',\'\'); return false;"><span>Droite<\/span><\/a>';
	<?php endif; ?>
