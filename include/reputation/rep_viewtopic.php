...
{ ?>
            ...
            ?><a href="./reputation.php?<?php echo $repdataplus; ?>"><img src="./img/warn_add.gif" alt="+" border="0"></a>&nbsp;&nbsp;<strong><?php echo $cur_post['count_rep_plus']-$cur_post['count_rep_minus']; ?>&nbsp;&nbsp;</strong><a href="./reputation.php?<?php echo $repdataminus; ?>"><img src="./img/warn_minus.gif" alt="-" border="0"></a><?php 
            }  
            else 
            {
