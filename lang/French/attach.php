...
// viewtopic.php
'Attachments:'			=>	'Pièce Jointe:',	// Used in viewtopic before attachments in the post.
'Size:'					=>	'Taille:',		// Used in viewtopic to show filesize of attachment.
'bytes'					=>	'bytes',		// Used in viewtopic after the filesize.
'Downloads:'			=>	'Téléchargements:',	// Used in viewtopic to show number of downloads.

//post.php
'Attachment'			=>	'Pièce Jointe',	// Used in post the legend name
...
//edit.php
'Delete?'				=>	'Supprimer?',		// Used in edit.php, after the delete checkbox for each attachment...
...
'Upload'				=>	'Pièce Jointe, max: %%ATTACHMENTS%%',	//Used in edit.php, before the upload field, %%ATTACHMENTS%% must be there, it will show how many attachment the user has as a maximum...
...
// attach.php
'Image view'			=>	'Image view',	// Used in attach.php, header on the Image view frame.
