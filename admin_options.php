...
if ($pun_user['g_id'] != PUN_ADMIN && $pun_user['g_id'] != '5')
...
if (isset($_POST['form_sent']))
{
	...
	$form = array(
		...
		'avatars_upload_size'	=> (intval($_POST['form']['avatars_upload_size']) > 0) ? intval($_POST['form']['avatars_upload_size']) : 1,
		'avatars_default'		=> (intval($_POST['form']['avatars_default']) > 0) ? intval($_POST['form']['avatars_default']) : 1,
	...
	// Easy Avatar : make sure avatars_upload_size doesn't exceed post_max_size set in config.ini (default : 1 Mb)
	...
	if (intval($form['avatars_upload_size']) > $max)
		$form['avatars_upload_size'] = $max;
					...
					<fieldset>
						...
						<div class="infldset">
							<table class="aligntop" cellspacing="0">
								...
								<!-- Easy avatar ------------------------------------------------------------------------------------------------------------------------------>
								<tr>
									<th scope="row"><?php echo $lang_EZavatar['Max upload size label'] ?></th>
									<td>
										<input type="text" name="form[avatars_upload_size]" size="7" maxlength="7" value="<?php echo $pun_config['o_avatars_upload_size'] ?>" />
										<span><?php echo $lang_EZavatar['Max upload size help'] ?></span>
									</td>
								</tr>
								<tr>
									<th scope="row"><?php echo $lang_EZavatar['Use default avatar'] ?></th>
									<td>
										<input type="radio" name="form[avatars_default]" id="form_avatars_default_1" value="1"<?php if ($pun_config['o_avatars_default'] == '1') echo ' checked="checked"' ?> />&#160;<label class="conl" for="form_avatars_default_1"><strong><?php echo $lang_admin_common['Yes'] ?></strong></label>&#160;&#160;&#160;<input type="radio" name="form[avatars_default]" id="form_avatars_default_0" value="0"<?php if ($pun_config['o_avatars_default'] == '0') echo ' checked="checked"' ?> />&#160;<label class="conl" for="form_avatars_default_0"><strong><?php echo $lang_admin_common['No'] ?></strong></label>
										<span><?php echo $lang_EZavatar['Use default avatar help'].'<br /><br />' ?></span>
										<span><?php echo $lang_EZavatar['Default avatar'].'<br />'.generate_avatar_markup(0).'<br />' ?><a href="profile.php?action=upload_avatar2&amp;id=0"><?php echo $lang_EZavatar['Upload default avatar'] ?></a></span>
									</td>
								</tr>
								<!--------------------------------------------------------------------------------------------------------------------------------------------->
							</table>
